...
\begin{itemize}
	...
	\item[-] Techniques for sharing Scala code between Akka.JVM and Akka.js;
       \item[-] An approach for enabling a strong form of interoperability between actors running on JavaScript runtimes and actors running on JVMs.
\end{itemize}
\noindent
