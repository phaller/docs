...
\alignauthor
Gianluca Stivan\\
       \affaddr{UniCredit - Group Research \& Open Innovation}\\
       \affaddr{Italy}\\
       \email{\small{GSTIVAN.external@unicredit.eu}}
% 2nd. author
\alignauthor
Andrea Peruffo\\
       \affaddr{UniCredit - Group Research \& Open Innovation}\\
       \affaddr{Italy}\\
       \email{\small{Andrea.Peruffo@unicredit.eu}}
% 3rd. author
\alignauthor Philipp Haller\\
       \affaddr{KTH Royal Institute of Technology}\\
       \affaddr{Sweden}\\
       \email{\small{phaller@kth.se}}
